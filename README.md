...
<br />  
<div align="center">  
  <h3>DevOps & Cloud Engineer | Full-Stack Engineer (MERN & React Native) | Bridging Dev & Ops</h3> 
</div>  
...
I am a **DevOps & Cloud Engineer** with a strong foundation as a **Full-Stack Engineer** specializing in the **MERN Stack and React Native**. My core focus is on automating infrastructure, managing cloud environments (AWS), and bridging the gap between development and operations to build scalable, highly available, and resilient systems.  

Currently, I am at **Spark Tech Agency**, where I focus on: 
- **Cloud Infrastructure:** Managing, automating, and optimizing scalable systems on **AWS**. 
- **System Orchestration:** Leveraging **Docker & Kubernetes** for efficient container management. 
- **Automation:** Implementing robust CI/CD pipelines to streamline development lifecycles.  
...
![Linux](https://img.shields.io/badge/Ubuntu-E95420.svg?style=flat&logo=ubuntu&logoColor=white)
...
- ⚙️ **Infrastructure as Code (IaC)** using Terraform and automated deployments. 
